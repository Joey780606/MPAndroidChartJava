...
import pcp.com.mympandroidcharttest.custom.DayAxisValueFormatter;
import pcp.com.mympandroidcharttest.custom.MyAxisValueFormatter;
import pcp.com.mympandroidcharttest.custom.XYMarkerView;
...
public class BarChartActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ValueFormatter xAxisFormatter = new DayAxisValueFormatter(chart);   // Horse important, above is old, this is newest
        ...
        ValueFormatter custom = new MyAxisValueFormatter();   // Horse important, above is old, this is newest
        ...
        rightAxis.setYOffset(-10f);     //這樣資料就會往上放
...
//            set1.setFills(gradientFills);
            ...
            // Horse important, above is old, newest info is list below
